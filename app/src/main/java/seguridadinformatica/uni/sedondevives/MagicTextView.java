...
public class MagicTextView extends TextView {
    ...
    public void init(AttributeSet attrs){
        ...
        if(attrs != null){
            ...
            if(a.hasValue(R.styleable.MagicTextView_nBackground)){
                Drawable background = a.getDrawable(R.styleable.MagicTextView_nBackground);
                if(background != null){
                    this.setBackgroundDrawable(background);
                }else{
                    this.setBackgroundColor(a.getColor(R.styleable.MagicTextView_nBackground, 0xff000000));
                }
            }
